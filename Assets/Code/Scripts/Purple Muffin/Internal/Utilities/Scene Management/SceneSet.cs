...
{
    [CreateAssetMenu(menuName = "PurpleMuffin/Scene Management/Scene Set")]
    public class SceneSet : PMScriptableObject
    {
        /// <summary>
        ///     The set scenes.
        /// </summary>
        ...
        [MenuItem("Assets/Purple Muffin/Create Scene Set", true)]
        public static bool CreateSceneSetFromSceneValidation()
        {
            return Selection.activeObject is SceneAsset;
        }

        [MenuItem("Assets/Purple Muffin/Create Scene Set %#S")]
