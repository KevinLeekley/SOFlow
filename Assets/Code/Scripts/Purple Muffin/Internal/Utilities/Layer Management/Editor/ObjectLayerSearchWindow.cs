...
namespace PurpleMuffin.Internal.LayerManagement
{
    public class ObjectLayerSearchWindow : EditorWindow
    {
        ...
        [MenuItem("PurpleMuffin/Object Layer Searcher")]
        public static void ShowWindow()
        {
            GetWindow<ObjectLayerSearchWindow>("PM-Object Layer Searcher");
        }

        private void OnGUI()
        {
            PMEditorUtilities.DrawHorizontalColourLayer(PMEditorSettings.PrimaryLayerColour, DrawSearchBar);
        ...
        private void DrawSearchBar()
        {
            ...
            if(PMEditorUtilities.DrawColourButton("Search", Color.cyan))
            {
