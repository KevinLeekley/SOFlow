...
namespace PurpleMuffin.Internal
{
    public static partial class PMEditorUtilities
    {
                                                     ...
                                                     Color            layerColour)
        {
            ...
            if(DrawColourButton(property.isExpanded ? "↑" : "↓", PMEditorSettings.AcceptContextColour, null,
                                GUILayout.MaxWidth(25f)))
                property.isExpanded = !property.isExpanded;

            GUILayout.FlexibleSpace();
            EditorGUILayout.LabelField(property.displayName, PMStyles.BoldCenterLabel);
            GUILayout.FlexibleSpace();

            EditorGUILayout.LabelField($"Size: {property.arraySize}", PMStyles.WordWrappedMiniLabel);
            ...
            if(DrawColourButton(addButtonContent.text, PMEditorSettings.AcceptContextColour, null,
                                                 ...
                                                 if(reorderableList == null)
                                                 {
                                                     ...
                                                     reorderableList.drawElementCallback +=
                                                         (rect, index, active, focused) =>
                                                         {
                                                             ...
                                                             if(EditorGUI.Toggle(rect, false, PMStyles.Button))
                                                                 reorderableList
                                                                    .serializedProperty
                                                                    .DeleteArrayElementAtIndex(index);

                                                             EditorGUI.LabelField(rect, "-", PMStyles.CenteredLabel);
